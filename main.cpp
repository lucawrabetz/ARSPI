...
int main() {
  ...
  // k = 1 print line
  cout << exact_objective_1 << " & " << heuristic_objective_1 << " & "
       << mip_time_1 << " & " << enum_time_1 << " & " << heuristic_time_1
       << endl;
  // k = 2 print line
  cout << exact_objective_2 << " & " << heuristic_objective_2 << " & "
       << mip_time_2 << " & " << enum_time_2 << " & " << heuristic_time_2
       << endl;
  // k = 3 print line
  cout << exact_objective_3 << " & " << heuristic_objective_3 << " & "
       << mip_time_3 << " & " << enum_time_3 << " & " << heuristic_time_3
       << endl;

  // k = 4 print line
  cout << exact_objective_4 << " & " << heuristic_objective_4 << " & "
       << mip_time_4 << " & " << enum_time_4 << " & " << heuristic_time_4
       << endl;
  // k = 5 print line
  cout << exact_objective_5 << " & " << heuristic_objective_5 << " & "
       << mip_time_5 << " & " << enum_time_5 << " & " << heuristic_time_5
       << endl;
  ...
  // printSolution(k3_solution, "k=3 solution (heuristic, using exact k=2 as
  // input)");
  ...
  // printSolution(k4_solution, "k=4 solution (heuristic, using exact k=3 as
  // input)");
  ...
  // printSolution(k5_solution, "k=5 solution (heuristic, using exact k=4 as
  // input)");
